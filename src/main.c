...
SystemType* systemSetup(void) {
	...
	printf("[LOG] Sytem is being initialized and set up...\n");
	// wiringPi Setup
	wiringPiSetup();
	...
	printf("[LOG-BH1750Sensor] BH1750Sensor Sensor is being initialized and set up...\n");
	...
	SystemContext *roompi_system_ctx = SystemContext__create(001, dht_sensor, bh_sensor, lcd_actuator, buzzer_actuator, leds_actuator);
